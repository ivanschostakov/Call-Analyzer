...
export function TemplatesPage({ companyId }: { companyId: number }) {
  ...
  return (
    ...
    >
      <SectionCard title="Новый шаблон" description="Создайте новый шаблон анализа с инструкцией и описанием.">
      ...
      <SectionCard title="Список шаблонов" description="Открывайте отчеты по шаблону, редактируйте и удаляйте устаревшие.">
