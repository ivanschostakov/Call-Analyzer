...
TRANSCRIPTION_LANGUAGE = getenv("TRANSCRIPTION_LANGUAGE", "ru")
...
PASSWORD_RESET_TOKEN_LIFETIME_MINUTES = max(int(getenv("PASSWORD_RESET_TOKEN_LIFETIME_MINUTES", 60)), 5)
...
AUDIO_RETENTION_DAYS = max(int(getenv("AUDIO_RETENTION_DAYS", 180)), 1)
AUDIO_CLEANUP_INTERVAL_SECONDS = max(int(getenv("AUDIO_CLEANUP_INTERVAL_SECONDS", 24 * 60 * 60)), 60)
