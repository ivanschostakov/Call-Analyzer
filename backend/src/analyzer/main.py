...
- Не считай простое упоминание имени достаточным: имя должно относиться к сотруднику, который ведет звонок, а не к клиенту, коллеге или адресату будущего обращения.
- Допускай очевидные ошибки распознавания имени только вместе с другими подтверждениями личности сотрудника.
